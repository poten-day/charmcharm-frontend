...
const TimeOverModal = ({ setTimeOver }: { setTimeOver: Dispatch<SetStateAction<boolean>> }) => {
  ...
  return (
    <div
      ...
      ref={backgroundRef}
    >
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-[320px] bg-slate-300 text-center radius-8 border-1-gray200 bg-white z-999 p-[20px]">
